package gg.sep.twitchapi.test.users;
...
import gg.sep.twitchapi.test.PaginatedTotalDataAPI;
import gg.sep.twitchapi.test.TwitchAPIConfig;
import gg.sep.twitchapi.test.model.DataListTotalPaginated;
import gg.sep.twitchapi.test.model.users.TwitchUsersFollows;
import gg.sep.twitchapi.test.model.users.UsersFollowsQuery;
