 ...
 */
@Log4j2
public class DataList<T extends APIObject> implements DataAPIObject<T> {
    @Getter private List<T> data = new ArrayList<>();

    /**
     * Builds the appropriate DataList using the specified GSON (from a builder), JSON string,
     ...
     * @param <T> Type of the object contained within the Data collection parameter.
     * @return Constructed DataList.
     */
    public static <T extends APIObject> DataList<T> fromJson(final Gson gson, final String json,
